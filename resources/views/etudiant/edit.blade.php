...
<div class="container-sm mt-5">
    <h1 class="text-center">@lang('lang.text_studentEdit_title')</h1>
    <div class="row justify-content-center">
        <form method="post" class="rounded-3 bg-dark shadow-lg p-4 mt-2 col-md-12 col-lg-8">
        @method('put')
        @csrf
            <div class="row mb-3">
                <div class="col-md-6 mb-3">
                    <label for="nom" class="form-label text-light">@lang('lang.text_student_name')</label>
                    <input type="text" class="form-control" id="nom" name="nom" placeholder="@lang('lang.text_placeholder_name')" value="{{ old('nom', $etudiant->nom) }}">
                    @if ($errors-> has('nom'))
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="adresse" name="adresse" placeholder="@lang('lang.text_placeholder_address')" value="{{ old('adresse', $etudiant->adresse) }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder="@lang('lang.text_placeholder_address')" value="{{ old('email',$etudiant->email) }}  " readonly>
                    @if ($errors-> has('email'))
                        <div class="text-danger mt-2">
                            {{ $errors->first('email') }}
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="tel" class="form-control" id="telephone" name="telephone" placeholder="@lang('lang.text_placeholder_phone')" value="{{ old('telephone', $etudiant->telephone) }}">
            ...
            <div class="row mb-3">
                ...
                @if ($villes->isNotEmpty())
                    ...
                    @else
                        <div class="alert alert-warning">@lang('lang.text_selectCity_alert_msg')</div>
                    @endif
