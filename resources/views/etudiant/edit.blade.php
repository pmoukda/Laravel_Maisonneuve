...
<div class="container-sm mt-5">
    <h1 class="text-center mb-4">Mettre à jour les infos de l'étudiant</h1>
    <form method="post" class="rounded-3 bg-dark shadow-lg p-4 mt-5">
        @method('put')
    @csrf
        <div class=" row mb-3">
            <div class="col-md-6 ">
                <label for="nom" class="form-label text-light">Nom complet</label>
                <input type="text" class="form-control" id="nom" name="nom" placeholder="Votre nom" value="{{ old('nom', $etudiant->nom) }}">
                @if ($errors-> has('nom'))
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="adresse" name="adresse" placeholder="Votre adresse" value="{{ old('adresse', $etudiant->adresse) }}">
        ...
        <div class=" row mb-3">
            <div class="col-md-6">
                ...
                <input type="email" class="form-control" id="email" name="email" placeholder="nom@abc.com" value="{{ old('email',$etudiant->email) }}  " readonly>
                @if ($errors-> has('email'))
                    <div class="text-danger mt-2">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="col-md-6">
                ...
                <input type="tel" class="form-control" id="telephone" name="telephone" placeholder="votre téléphone" value="{{ old('telephone', $etudiant->telephone) }}">
        ...
        <button type="submit" class="btn bg-primary bg-gradient mt-5 fs-5 fw-bold mx-auto d-block w-100 ">Enregistrer</button>
    </form> 
</div>
@endsection('content')