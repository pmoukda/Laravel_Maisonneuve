...
return [
    ...
    "text_login_title" => "Se connecter",
    "text_form_login_email" => "Nom d'utilisateur ou Courriel",
    ...
    // page inscription
    "text_form_name" => "Nom",
    "text_form_email" => "Courriel",
    "text_form_confirm_pw" => "Reconfirmation du mot de passe",
    "text_placeholder_name" => "Votre nom",
    "text_placeholder_email" => "Votre courriel",
    ...
    // page des étudiants
    "text_studentIndex_title" => "Les étudiants de Maisonneuve",
    "text_studentIndex_city" => "Ville:",
    "text_studentIndex_link" => "Voir profil",
    "text_studentShow_title" => "L'étudiants",
    "text_info_address" => "Adresse:",
    "text_info_city" => "Ville:",
    "text_info_email" => "Courriel:",
    "text_info_phone" => "Numéro de téléphone:",
    ...
    "text_student_city" => "Ville",
    "text_student_birthDate" => "Date de naissance",
    "text_student_select_city" => "Choisir une ville",
    "text_placeholder_phone" => "Votre numéro de téléphone",
    "text_placeholder_address" => "Votre Adresse",
    "text_placeholder_emailExample" => "nom@abc.com",
    ...
    "text_userTable_head" => '<th class="col-md-5 px-4">Noms</th>
                              <th class="col-md-5">Courriels</th>
    ...
    "validation_birthDate_before" => "Vous devez avoir au moins 16 ans.",
    "validation_birthDate_after" => "Vous devez avoir moins de 65 ans.",
